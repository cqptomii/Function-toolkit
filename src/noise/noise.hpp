...
class Noise {
    public:
        ...
        virtual double fbm(double x, double y, double z, int octaves = 6, double amplitude = 1.0, double frequency = 1.0, double persistence = 0.5, double lacunarity = 2.0) const {
                double total = 0.0;
